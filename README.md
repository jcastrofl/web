...
![Skill's Engineer Logo](public/img/logo.png)
...
```
/
├── index.php              # Archivo principal que redirige a /public/
├── .htaccess              # Configuración global de Apache
├── public/                # Carpeta con todos los archivos accesibles públicamente
│   ├── index.html         # Página principal
│   ├── .htaccess          # Configuración de Apache para /public/
...
│   └── README.md          # Documentación del proyecto en la carpeta public
...
2. Configuración con XAMPP:
   ...
   - Accede a http://localhost/web_/ en tu navegador (redirigirá automáticamente a /public/)
   - También puedes acceder directamente a http://localhost/web_/public/

3. Configuración en servidor web:
   - Sube todos los archivos a tu servidor
   - Asegúrate de que el servidor web pueda leer el archivo .htaccess
   - El sitio se cargará automáticamente desde la carpeta public
